...
uint32_t tair_serv_Tair_put_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("area", ::apache::thrift::protocol::T_I64, 1);
  xfer += oprot->writeI64(this->area);
  xfer += oprot->writeFieldEnd();
...
bool tair_servClient::Tair_begin(const std::string& master_addr, const std::string& slave_addr, const std::string& group_name)
{
...
bool tair_servClient::recv_Tair_begin()
{
...
int64_t tair_servClient::Tair_put(const int64_t area, const std::string& key, const std::string& data, const int64_t expire, const int64_t version)
{
  send_Tair_put(area, key, data, expire, version);
  return recv_Tair_put();
}

void tair_servClient::send_Tair_put(const int64_t area, const std::string& key, const std::string& data, const int64_t expire, const int64_t version)
{
  int32_t cseqid = 0;
...
int64_t tair_servClient::recv_Tair_put()
{
...
void tair_servClient::Tair_get(std::string& _return, const int64_t area, const std::string& key)
{
  send_Tair_get(area, key);
  recv_Tair_get(_return);
}

void tair_servClient::send_Tair_get(const int64_t area, const std::string& key)
{
  int32_t cseqid = 0;
...
void tair_servClient::recv_Tair_get(std::string& _return)
{
...
int64_t tair_servClient::Tair_remove(const int64_t area, const std::string& key)
{
  send_Tair_remove(area, key);
  return recv_Tair_remove();
}

void tair_servClient::send_Tair_remove(const int64_t area, const std::string& key)
{
  int32_t cseqid = 0;
...
int64_t tair_servClient::recv_Tair_remove()
{
...
void tair_servProcessor::process_Tair_get(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->Tair_get(result.success, args.area, args.key);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
bool tair_servConcurrentClient::Tair_begin(const std::string& master_addr, const std::string& slave_addr, const std::string& group_name)
{
...
bool tair_servConcurrentClient::recv_Tair_begin(const int32_t seqid)
{
...
int64_t tair_servConcurrentClient::Tair_put(const int64_t area, const std::string& key, const std::string& data, const int64_t expire, const int64_t version)
{
  int32_t seqid = send_Tair_put(area, key, data, expire, version);
  return recv_Tair_put(seqid);
}

int32_t tair_servConcurrentClient::send_Tair_put(const int64_t area, const std::string& key, const std::string& data, const int64_t expire, const int64_t version)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("Tair_put", ::apache::thrift::protocol::T_CALL, cseqid);
...
int64_t tair_servConcurrentClient::recv_Tair_put(const int32_t seqid)
{
...
void tair_servConcurrentClient::Tair_get(std::string& _return, const int64_t area, const std::string& key)
{
  int32_t seqid = send_Tair_get(area, key);
  recv_Tair_get(_return, seqid);
}

int32_t tair_servConcurrentClient::send_Tair_get(const int64_t area, const std::string& key)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("Tair_get", ::apache::thrift::protocol::T_CALL, cseqid);
...
void tair_servConcurrentClient::recv_Tair_get(std::string& _return, const int32_t seqid)
{
...
int64_t tair_servConcurrentClient::Tair_remove(const int64_t area, const std::string& key)
{
  int32_t seqid = send_Tair_remove(area, key);
  return recv_Tair_remove(seqid);
}

int32_t tair_servConcurrentClient::send_Tair_remove(const int64_t area, const std::string& key)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("Tair_remove", ::apache::thrift::protocol::T_CALL, cseqid);
...
int64_t tair_servConcurrentClient::recv_Tair_remove(const int32_t seqid)
{
