...
class tair_servIf {
 public:
  virtual ~tair_servIf() {}
  virtual bool Tair_begin(const std::string& master_addr, const std::string& slave_addr, const std::string& group_name) = 0;
  virtual void Tair_set_loglevel(const std::string& level) = 0;
  virtual int64_t Tair_put(const int64_t area, const std::string& key, const std::string& data, const int64_t expire, const int64_t version) = 0;
  virtual void Tair_get(std::string& _return, const int64_t area, const std::string& key) = 0;
  virtual int64_t Tair_remove(const int64_t area, const std::string& key) = 0;
};
...
class tair_serv_Tair_put_args {
 public:
  ...
  tair_serv_Tair_put_args() : area(0), key(), data(), expire(0), version(0) {
  }
  ...
  void __set_area(const int64_t val);
...
typedef struct _tair_serv_Tair_get_args__isset {
  _tair_serv_Tair_get_args__isset() : area(false), key(false) {}
  bool area :1;
  bool key :1;
...
class tair_serv_Tair_get_args {
 public:
  ...
  tair_serv_Tair_get_args() : area(0), key() {
  }
...
class tair_serv_Tair_get_result {
 public:
  ...
  tair_serv_Tair_get_result() : success() {
  }
...
class tair_serv_Tair_remove_args {
 public:
  ...
  tair_serv_Tair_remove_args() : area(0), key() {
  }
...
class tair_servClient : virtual public tair_servIf {
 ...
 public:
  ...
  bool recv_Tair_begin();
  void Tair_set_loglevel(const std::string& level);
  void send_Tair_set_loglevel(const std::string& level);
  void recv_Tair_set_loglevel();
  int64_t Tair_put(const int64_t area, const std::string& key, const std::string& data, const int64_t expire, const int64_t version);
  void send_Tair_put(const int64_t area, const std::string& key, const std::string& data, const int64_t expire, const int64_t version);
  int64_t recv_Tair_put();
  void Tair_get(std::string& _return, const int64_t area, const std::string& key);
  void send_Tair_get(const int64_t area, const std::string& key);
  void recv_Tair_get(std::string& _return);
  int64_t Tair_remove(const int64_t area, const std::string& key);
  void send_Tair_remove(const int64_t area, const std::string& key);
  int64_t recv_Tair_remove();
 protected:
...
class tair_servMultiface : virtual public tair_servIf {
 ...
 public:
  ...
  void Tair_get(std::string& _return, const int64_t area, const std::string& key) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->Tair_get(_return, area, key);
    }
    ifaces_[i]->Tair_get(_return, area, key);
    return;
  }
...
class tair_servConcurrentClient : virtual public tair_servIf {
 ...
 public:
  ...
  bool recv_Tair_begin(const int32_t seqid);
  void Tair_set_loglevel(const std::string& level);
  int32_t send_Tair_set_loglevel(const std::string& level);
  void recv_Tair_set_loglevel(const int32_t seqid);
  int64_t Tair_put(const int64_t area, const std::string& key, const std::string& data, const int64_t expire, const int64_t version);
  int32_t send_Tair_put(const int64_t area, const std::string& key, const std::string& data, const int64_t expire, const int64_t version);
  int64_t recv_Tair_put(const int32_t seqid);
  void Tair_get(std::string& _return, const int64_t area, const std::string& key);
  int32_t send_Tair_get(const int64_t area, const std::string& key);
  void recv_Tair_get(std::string& _return, const int32_t seqid);
  int64_t Tair_remove(const int64_t area, const std::string& key);
  int32_t send_Tair_remove(const int64_t area, const std::string& key);
  int64_t recv_Tair_remove(const int32_t seqid);
 protected:
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
